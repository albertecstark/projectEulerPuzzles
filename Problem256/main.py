...
Assuming that the only type of available tatami has dimensions 1×2, there are obviously some limitations
...
The arrangement on the left is acceptable, whereas the one on the right is not: an "X" in the middle,
marks the point where four tatami meet.
...
# find No of 2x1 tilings possible for a given size, break down into whether or not these are acceptable,
# if No acceptable tilings is 200, then we have found our smallest size
